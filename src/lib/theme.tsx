...
import { AppTheme, ColorType } from '@types'
...
// 	return getTheme()[color] || (color as ColorProps)
// }

export const colors = LightColors

const getTheme = () => {
	const theme = 'dark' //process.browser && (localStorage.getItem('theme') as any)
	return theme === 'dark' ? DarkColors : LightColors
}

export const LocalTheme: AppTheme = {
	colors: getTheme(),
}
